...
static const char qt_meta_stringdata_mapPaint[] = {
    "mapPaint\0"
};

const QMetaObject mapPaint::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_mapPaint,
      qt_meta_data_mapPaint, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &mapPaint::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_mapPaint))
